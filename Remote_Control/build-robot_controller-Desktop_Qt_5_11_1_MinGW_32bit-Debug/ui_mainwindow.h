...
"}"));
        ...
        lcdP->setObjectName(QStringLiteral("lcdP"));

        gridLayout_2->addWidget(lcdP, 1, 2, 1, 1);

        lcdD = new QLCDNumber(centralWidget);
        lcdD->setObjectName(QStringLiteral("lcdD"));
        ...
        Slider_WorkingAngle->setObjectName(QStringLiteral("Slider_WorkingAngle"));
        Slider_WorkingAngle->setMinimum(20);
        Slider_WorkingAngle->setMaximum(70);
        ...
        Slider_UdateFerquency->setObjectName(QStringLiteral("Slider_UdateFerquency"));
        ...
        Slider_ComplemetaryFilter->setObjectName(QStringLiteral("Slider_ComplemetaryFilter"));
        Slider_ComplemetaryFilter->setMinimum(900);
        Slider_ComplemetaryFilter->setMaximum(999);
        Slider_ComplemetaryFilter->setValue(950);
        ...
        Slider_PIDMaxSpeed->setObjectName(QStringLiteral("Slider_PIDMaxSpeed"));
        ...
        Slider_DefaultSetPoint->setObjectName(QStringLiteral("Slider_DefaultSetPoint"));
