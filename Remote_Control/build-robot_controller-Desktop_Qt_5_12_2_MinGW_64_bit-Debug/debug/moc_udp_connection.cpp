...
QT_MOC_LITERAL(1, 15, 9), // "udpUpdate"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "readyRead"
QT_MOC_LITERAL(4, 36, 4) // "send"

    },
    "UDP_Connection\0udpUpdate\0\0readyRead\0"
    "send"
};
...
void UDP_Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UDP_Connection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->udpUpdate(); break;
        ...
        {
            using _t = void (UDP_Connection::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDP_Connection::udpUpdate)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UDP_Connection::staticMetaObject = { {
    ...
    qt_meta_stringdata_UDP_Connection.data,
    qt_meta_data_UDP_Connection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
